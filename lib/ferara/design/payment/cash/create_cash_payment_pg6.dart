...
import 'detail/select_cash_account_ledger.dart';

class CreateCashPayment extends StatefulWidget {
  const CreateCashPayment({Key? key}) : super(key: key);

  @override
  State<CreateCashPayment> createState() => _CreateCashPaymentState();
}

class _CreateCashPaymentState extends State<CreateCashPayment> {
    ...
    return SizedBox(
      ...
      child: TextField(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => SelectCashAccountLedger()),
            );
          },
      ...
      children: [
        ...
        SizedBox(
          ...
          child: TextField(
              ...
              keyboardType: TextInputType.number,
              decoration: TextFieldStyle.textField(context,
                  hintTextStr: "Net Amount",
                  labelTextStr: "Net Amount")),
        ),
      ],
    );
  }

...
import 'bank/create_bank_payment_pg7.dart';
import 'cash/create_cash_payment_pg6.dart';
        ...
        children: [
          SizedBox(
            ...
            child: TextButton(
              ...
              style: TextButton.styleFrom(
                primary:
                    buttonColor == 1 ? const Color(0xffffffff) : buttonText1,
                backgroundColor:
                    buttonColor == 1 ? const Color(0xff272727) : buttonBack1,
              ),
              onPressed: () {
                setState(() {
                  buttonColor = 1;
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => CreateCashPayment()),
                  );
                });
                // print('Pressed');
              },
          ...
          SizedBox(
            ...
            child: TextButton(
              ...
              style: TextButton.styleFrom(
                primary:
                    buttonColor == 2 ? const Color(0xffffffff) : buttonText1,
                backgroundColor:
                    buttonColor == 2 ? const Color(0xff272727) : buttonBack1,
              ),
              onPressed: () {
                setState(() {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => CreateBankPayment()),
                  );
...
///list builder scrolling not working properly
...
import 'package:test_project/ferara/design/payment/cash/detail/select_cash_account_ledger.dart';

import '../../decoration.dart';
import 'detail/select_bank_account_ledger.dart';

class CreateBankPayment extends StatefulWidget {
  const CreateBankPayment({Key? key}) : super(key: key);

  @override
  State<CreateBankPayment> createState() => _CreateCashPaymentState();
}

class _CreateCashPaymentState extends State<CreateBankPayment> {
      ...
      child: TextField(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => SelectBankAccountLedger()),
            );
          },
...
///underline for textfield typing text in noteDetail widget
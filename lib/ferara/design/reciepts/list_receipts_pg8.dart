...
import 'package:test_project/ferara/design/reciepts/bank/create/create_bank_payment_pg10.dart';

import '../decoration.dart';
import 'cash/create_cash_payment_pg9.dart';
...
class _ReceiptsState extends State<Receipts> {
  ...
  Color buttonBackColor = const Color(0xffEEEEEE);
  Color buttonTextColor = const Color(0xff000000);
        ...
        children: [
          SizedBox(
            ...
            child: TextButton(
              ...
              style: TextButton.styleFrom(
                primary:
                buttonIndex == 1 ? const Color(0xffffffff) : buttonTextColor,
                backgroundColor: buttonIndex == 1 ? const Color(0xff272727) : buttonBackColor,
              ),
              onPressed: () {
                setState(() {
                  buttonIndex = 1;
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => ReceiptsCashPayment()),
                  );
                });
                // print('Pressed');
              },
          ...
          SizedBox(
            ...
            child: TextButton(
              ...
              style: TextButton.styleFrom(
                primary:
                buttonIndex == 2 ? const Color(0xffffffff) : buttonTextColor,
                backgroundColor:
                buttonIndex == 2 ? const Color(0xff272727) : buttonBackColor,
              ),
              onPressed: () {
                setState(() {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => ReceiptBankPayment()),
                  );
